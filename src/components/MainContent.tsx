  ...
  return (
    <div className="py-20 px-10 text-right flex flex-col gap-10">
      ...
      <p className="text-gray-500 leading-7">
        ...
        شناخته شده، مانند بایننس (Binance)، ارز های دیجیتال خود را با دلار، پوند، یورو و
        غیره جایگزین کنید. خطر اصلی در همین مرحله اتفاق می افتد جایی که هکر ها و
        بدافزار ها امکان بلوکه کردن پول شما را در حین این انتقال دارا هستند.
      </p>

      <div className="max-w-[600px] mx-auto">
        <Image
          src="/image/Group 806.png"
          alt="تصویر رمز ارزها"
          width={600}
          height={400}
